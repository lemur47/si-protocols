---
title: "Egregores: When Containers Harvest Their Hosts"
description: How stateful containers — living collective systems — sustain themselves by extracting resources from their members, and what that means for container escape.
order: 8
---

## Beyond Static Containers

The [Virtualisation Model](/the-virtualisation-model/) introduces Layer 6 — the Container layer — as shared cultural and social packaging that standardises output across instances. Language, ethics, social norms. Dockerised common sense.
...
1. **Emission** — instances contribute outbound signals: money, attention, labour, emotional energy, behavioural compliance
2. **Aggregation** — the system collects and processes the collective output of all instances
3. **Strengthening** — the system grows more coherent, more demanding, more capable of directing its instances
4. **Redistribution** — the system pushes refined inbound signals back to all instances: identity, status, belonging, purpose, access
5. **Compliance** — instances respond to the inbound signals, contribute more, and the loop accelerates
...
For the full technical specification of the CVP model, see the [developer documentation](https://spiritualintelligence.dev). For an introduction to the layer stack, see [The Virtualisation Model](/the-virtualisation-model/).
