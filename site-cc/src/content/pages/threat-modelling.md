...
description: Applying security thinking to understand risks in metaphysical and spiritual contexts.
order: 2
---
...
1. **What are we protecting?** — Autonomy, financial wellbeing, psychological health, and the freedom to form genuine spiritual connections.
2. **What could go wrong?** — Manipulation, financial exploitation, emotional coercion, isolation from support networks, and identity erosion.
...
Explore [common threats](/common-threats/) to see these patterns in action.
