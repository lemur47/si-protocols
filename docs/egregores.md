# Egregores: When Containers Harvest Their Hosts

_Originally published on spiritualintelligence.cc._

## Beyond Static Containers

The [Virtualisation Model](./the-virtualisation-model.md) introduces Layer 6 — the Container layer — as shared cultural and social packaging that standardises output across instances. Language, ethics, social norms. Dockerised common sense.
...
For the full technical specification of the CVP model, see the [developer documentation](https://github.com/lemur47/si-protocols). For an introduction to the layer stack, see [The Virtualisation Model](./the-virtualisation-model.md).
