...
1. **Individual claims** (micro) — each extracted statement with its classification and scores
2. **Grouped by kind** (meso) — summaries of the pseudo, true, and indeterminate clusters
3. **Whole text** (macro) — an overall picture of the text's structural composition
...
![Topology analysis of a suspicious text, showing individual claims classified and connected across three layers](./images/topology-example.svg)
...
Continue to [The Virtualisation Model](./the-virtualisation-model.md) to explore the conceptual framework behind these classifications — where claims come from, and why some content resonates deeply whilst carrying manufactured conclusions.
