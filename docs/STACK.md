...
| `AnthropicEngine` (Tier 1) | Claude API claim extraction (opt-in extra) | Shipped, but **presumed broken** — pinned model retired 2026-06-15, unverified against a live endpoint |
